...
<?php include($_SERVER['DOCUMENT_ROOT'].'/templates/navp.php') ?>
        ...
        <div class="container">
            <div class="Home">
			 <a href="/projects/g"><button type="button" class="btn btn-lg btn-success"><---  Back To All Games</button></a>
			<h2>Microlife</h2>
						<p>Control and help a family of microbes by providing them with food and resources, whilst protecting them from predators!</p>
			<object width="100%" height="700">
    <param name="movie" value="swf/microlife.swf">
    <embed src="swf/microlife.swf" width="100%" height="100%">
    </embed>
</object>
