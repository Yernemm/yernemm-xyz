...
var mfea1 = ["There's going to be some awesome verticality to it", "It has many sneaky flank routes", "It features a variety of jump pads", "We decided to play around with the concept of adding ladders", "It has some small tunnels in which only small heroes can fit", "It's one of the largest maps we've made", "It's one of the smallest maps for the chosen gamemode", "It's an average-sized map", "It has some cool unique powerups", "It has large open spaces", "It is quite linear with many choke points"]
var conn = ["and", "and also"]
var mfea2 = ["it has some great sight lines for snipers", "it has some new working elevators", "it has a sort of force field which lifts heroes up, kind of like an elevator", "it has a bunch of moving floating platforms everywhere", "it has some anti-gravity fields", "it has a low gravity zone", 'it has this cool "sticky" wall that allows some heroes to walk on walls but they fall off if stunned or knocked back', "It has a special orb in the centre that a team can collect and return to their spawn to debuff the enemy team.", "It has some awesome map events, sort of similar to how maps work in Heroes of the Storm"]
...
var hen2 = ["fist", "quake", "red", "violet", "monk", "blade", "robot", "sword", "gun", "orb", "boot", "hood", "born", "yatta", "oni", "night", "knight", "maker", "-man", "-woman", "rider", "hand", "run", "kin", "rim"]
...
var ab1 = ["They have this cool ability called ", "We experimented with a new ability called ", "We gave it a cool new ability called ", "It has this weird ability called ", "We tried something new with the ability called ", "We were inspired by other hero abilities and we made the ability called ", "We tried something unique by adding an ability called "]

var nab1 = ["re", "over", "trans", "pro", "de", "over", "tele", "super", "under", "bright", "con", "swift", "dragon", "cat", "free", "cryo", "bio", "nano", "cease"]
var nab2 = ["port", "position", "extend", "hook", "verse", "watch", "locate", "duce", "cussion", "see", "lap", "-jump", "strike", "walk", "run", "freeze", "burn", "wet", "wind", "water"]
...
var averb = ["jump over", "heal", "instantly eliminate", "eliminate", "block off", "shield", "help", "defend", "attack", "damage", "debuff", "buff", "hack", "disable", "control", "fly over", "see through walls around", "charge towards", "teleport to", "Slowly walk towards", "delete", "crash", "blind", "annoy", "mildly inconvenience", "ride on", "jump on", "crawl under", "pick up", "lift"]
var anoun = [" every enemy. ", " every ally. ", " a selected enemy. ", " a selected ally. ", " a targeted location. ", " the enemy spawn door. ", " the area around the current objective. ", " low health allies. ", " low health enemies. ", " a straight line. ", " anywhere. ", " any targeted player. ", " a radius around the hero. "]
var conti = ["We think that this hero will be very useful for ", "These abilities allow the hero to be effective at ", "We believe that the hero will be good at ", "With this, we hope to make a hero which can be good at ", "We tried to fill a certain role with this; we think that the hero will be good at ", "This might make the hero good at ", "Unfortuantely, this means that the hero is ineffective at ", "It makes the hero bad at "]
var role1 = ["flanking the enemies and surprising them", "healing allies", "being an annoyance", "front-line brawling", "back-line harassment", "eliminating squishy targets", "supporting the team", "blocking enemy damage", "distracting the enemy", "being overpowered", "being exploited and milked for views on YouTube", "nothing", "everything", "something. We're not sure what though"]

var addcont = ["shorts", "animated shorts", "origin stories", "comics", "content updates", "events"]

var closer = ["That's all I was able to see.", "Have fun with the new content ;)", "That's all I know so far.", "And that is it as far as I'm aware.", "That's all I'm going to share for now", "Good luck with your lootboxes ;)", "There's some more stuff being developed but I won't spoil much."]
